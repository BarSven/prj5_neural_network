...
namespace Emgu.CV.XFeatures2D
{
    ...
    public class CudaSURF : UnmanagedObject
    {
        ...
        public CudaSURF(
           ...
           bool upright = false)
        {
            _ptr = XFeatures2DInvoke.cudaSURFDetectorCreate(hessianThreshold, nOctaves, nOctaveLayers, extended, featuresRatio,
               upright);
        }
        ...
        public GpuMat DetectKeyPointsRaw(GpuMat img, GpuMat mask = null)
        {
            ...
            XFeatures2DInvoke.cudaSURFDetectorDetectKeyPoints(_ptr, img, mask, result);
            return result;
        }
        ...
        public GpuMat ComputeDescriptorsRaw(GpuMat image, GpuMat mask, GpuMat keyPoints)
        {
            ...
            XFeatures2DInvoke.cudaSURFDetectorCompute(_ptr, image, mask, keyPoints, descriptors, true);
            return descriptors;
        }
        ...
        {
            get { return XFeatures2DInvoke.cudaSURFDetectorGetDescriptorSize(_ptr); }
        }
